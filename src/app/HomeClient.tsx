...
interface HomeClientProps {
  initialGroupSessions: TutorSession[];
  initialOneOnOneSessions: TutorSession[];
  initialFeaturedTutors: Tutor[];
  initialCommunities: Community[];
  initialPaginationState: {
    hasMoreGroup: boolean;
    hasMoreOneOnOne: boolean;
...
export default function HomeClient({
  ...
  // Pagination flags
  const [hasMoreGroup, setHasMoreGroup] = useState(
    initialPaginationState.hasMoreGroup,
  );
  const [hasMoreOneOnOne, setHasMoreOneOnOne] = useState(
    initialPaginationState.hasMoreOneOnOne,
  );
  const [hasMoreTutors, setHasMoreTutors] = useState(
    initialPaginationState.hasMoreTutors,
  );
  const [hasMoreCommunities, setHasMoreCommunities] = useState(
    initialPaginationState.hasMoreCommunities,
  );
  ...
  // Updated Session Card component from page_bkup.tsx
    ...
    return (
      ...
      >
        ...
        <div className="p-3 flex items-center gap-2 border-b border-gray-100">
          ...
          <div className="w-10 h:10 md:w-15 md:h-15 rounded-full bg-gradient-to-br from-purple-100 to-blue-100 overflow-hidden flex-shrink-0">
  ...
  // Community Card component (unchanged)
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-max mx-auto px-4 sm:px-20 lg:px-20 py-8 space-y-12">
