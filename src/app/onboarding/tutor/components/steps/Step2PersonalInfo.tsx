// src/app/onboarding/tutor/components/steps/Step2PersonalInfo.tsx
"use client";
...
const Step2PersonalInfo = forwardRef<HTMLFormElement, Step2PersonalInfoProps>(
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Required fields: Name, Date of Birth, National ID, Front & Back
                ID Photos
              </p>
            </div>
